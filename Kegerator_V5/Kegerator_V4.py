...
############## Custom Fuctions ###################################
    ...
    def COMMAND_START_POUR(self):
        ...
        if any(self.Beer_Selected_State) and self.Pouring_State is not True:
            ...
            while(self.Done_Bit is False or self.Pouring_State is False):
                self.Done_Bit = Kegerator_V4_support.READ_DONE_BIT()
                time.sleep(0.1)
                """if self.Done_Bit is True:
    ...
    def Update_Status_Bar(self):
        ...
        if (self.Pouring_State is True) and (any(self.Beer_Selected_State)) and (self.Cleaning_State is False) and (self.Done_Bit is False):
            # 'Pouring'
            self.Label_Value_Status.configure(text=self.Status_Text[2])
            self.Pouring_State = False    
        elif (self.Pouring_State is False) and (any(self.Beer_Selected_State)) and (self.Cleaning_State is False) and (self.Done_Bit is False):
            # 'Ready'
            self.Label_Value_Status.configure(text=self.Status_Text[1])   
        elif (self.Pouring_State is False) and (all(self.Beer_Selected_State)) is False and (self.Cleaning_State is False) and (self.Done_Bit is False):
            # 'Select Beer Size'
            self.Label_Value_Status.configure(text=self.Status_Text[0])   
        elif (self.Pouring_State is False) and (self.Done_Bit is True):
            # 'Finished'
