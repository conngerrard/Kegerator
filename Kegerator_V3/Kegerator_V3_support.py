...
def COMMAND_START_POUR(): #Not Used
    print('Kegerator_V3_support.COMMAND_START_POUR')
    sys.stdout.flush()

def COMMAND_STOP_POUR(): #Not Used
    print('Kegerator_V3_support.COMMAND_STOP_POUR')
    sys.stdout.flush()
 
def COMMAND_CLEAN(): #Not Used
    print('Kegerator_V3_support.COMMAND_CLEAN')
    sys.stdout.flush()

def COMMAND_RESET_CUMULATIVE(): #Not Used
    print('Kegerator_V3_support.COMMAND_RESET_CUMULATIVE')
    sys.stdout.flush()

def COMMAND_RESET_KEG_LEVEL(): #Not Used
    print('Kegerator_V3_support.COMMAND_RESET_KEG_LEVEL')
    sys.stdout.flush()

def COMMAND_SAMPLER(): #Not Used
    print('Kegerator_V3_Carbon_support.COMMAND_SAMPLER')
    sys.stdout.flush()

def COMMAND_SMALL(): #Not Used
    print('Kegerator_V3_Carbon_support.COMMAND_SMALL')
    sys.stdout.flush()

def COMMAND_LARGE(): #Not Used
    print('Kegerator_V3_Carbon_support.COMMAND_LARGE')
    sys.stdout.flush()
