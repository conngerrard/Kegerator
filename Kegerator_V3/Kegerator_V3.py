...
import Kegerator_V3_support

def vp_start_gui():
    '''Starting point when module is the main routine.'''
    global val, w, root
    root = tk.Tk()
    Kegerator_V3_support.set_Tk_var()
    top = Main (root)
    Kegerator_V3_support.init(root, top)
    root.mainloop()
...
def create_Main(rt, *args, **kwargs):
    ...
    Kegerator_V3_support.set_Tk_var()
    top = Main (w)
    Kegerator_V3_support.init(w, top, *args, **kwargs)
    return (w, top)
...
############## Values that Need to be Updated #####################
        ...
        self.Errors_Text = ['Replace Keg','Check CO2','Check Leaks','Upgrade Cleaning Hardware']
####################################################################
        ...
        self.Button_CLEAN.configure(command=Kegerator_V3_support.COMMAND_CLEAN)
        ...
        self.Label_HERR_FAUSS.configure(text='''HERR FAUSS''')
        ...
        self.CheckButton_Sampler.place(relx=0.178, rely=0.5, relheight=0.065, relwidth=0.625)
        ...
        self.CheckButton_Sampler.configure(variable=Kegerator_V3_support.CheckSampler)

        self.CheckButton_Small = tk.Checkbutton(self.MIDDLE)
        self.CheckButton_Small.place(relx=0.13, rely=0.583, relheight=0.065, relwidth=0.625)
        ...
        self.CheckButton_Small.configure(variable=Kegerator_V3_support.CheckSmall)

        self.CheckButton_Large = tk.Checkbutton(self.MIDDLE)
        self.CheckButton_Large.place(relx=0.154, rely=0.667, relheight=0.065, relwidth=0.625)
        ...
        self.CheckButton_Large.configure(variable=Kegerator_V3_support.CheckLarge)
        ...
        self.Label_Value_Keg_Level.place(relx=0.562, rely=0.292, height=35, width=85)
        ...
        self.Label_Value_CO2.place(relx=0.562, rely=0.385, height=35, width=85)
        ...
        self.Label_Value_Cumulative.place(relx=0.562, rely=0.594, height=35, width=85)
        ...
        self.Label_Error_Bar.place(relx=0.319, rely=0.885, height=45, width=125)
        ...
        self.Label_Error_Bar.configure(font="-family {Segoe UI} -size 12")
        ...
        self.Label_Value_Error.place(relx=0.475, rely=0.885, height=45, width=155)
        ...
        self.Label_Value_Error.configure(font="-family {Segoe UI} -size 12")
        ...
        self.Label_Status_Bar.place(relx=0.319, rely=0.771, height=45, width=125)
        ...
        self.Label_Status_Bar.configure(font="-family {Segoe UI} -size 12")
        ...
        self.Label_Value_Status.place(relx=0.475, rely=0.771, height=45, width=155)
        ...
        self.Label_Value_Status.configure(font="-family {Segoe UI} -size 12")
...
############## Custom Fuctions ###################################
    ...
    def COMMAND_START_POUR(self):
        ...
        if any(self.Beer_Selected_State):
            # Kegerator_V3_support.WRITE_LED(True)
            self.Pouring_State = True
            Kegerator_V3_support.WRITE_GO_BIT(self.tracker_beer)
            self.Set_Cumulative()
            self.Set_Keg_Level()
            self.Update_Status_Bar()
            Kegerator_V3_support.READ_DONE_BIT()
        self.COMMAND_STOP_POUR()

    def COMMAND_STOP_POUR(self):
        if self.Pouring_State:
            self.Pouring_State = False
            Kegerator_V3_support.WRITE_RESET_PORTS()
        self.Update_Status_Bar()

    def COMMAND_CLEAN(self):
        if self.Pouring_State is not True:
            self.Cleaning_State = True
        self.Update_Status_Bar()

    def COMMAND_READ_PRESSURE(self):
        self.CO2 = Kegerator_V3_support.READ_PRESSURE_SENSOR()
    ...
    def Update_Status_Bar(self):
        ...
        if self.Pouring_State and any(self.Beer_Selected_State):
            # 'Pouring'
            self.Label_Value_Status.configure(text=self.Status_Text[2])
        elif self.Pouring_State == False and any(self.Beer_Selected_State):
            # 'Ready'
            self.Label_Value_Status.configure(text=self.Status_Text[1])
        elif self.Pouring_State == False and all(self.Beer_Selected_State) == False:
            # 'Select Beer Size'
            self.Label_Value_Status.configure(text=self.Status_Text[0]) 
