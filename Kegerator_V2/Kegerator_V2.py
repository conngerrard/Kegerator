...
import Kegerator_V2_support

def vp_start_gui():
    '''Starting point when module is the main routine.'''
    global val, w, root
    root = tk.Tk()
    Kegerator_V2_support.set_Tk_var()
    top = Main (root)
    Kegerator_V2_support.init(root, top)
    root.mainloop()
...
def create_Main(rt, *args, **kwargs):
    ...
    Kegerator_V2_support.set_Tk_var()
    top = Main (w)
    Kegerator_V2_support.init(w, top, *args, **kwargs)
    return (w, top)
...
############## Values that Need to be Updated #####################
        ...
        self.Errors_Text = ['Replace Keg','Check CO2','Check Leaks']
####################################################################
        ...
        self.Button_CLEAN.configure(command=Kegerator_V2_support.COMMAND_CLEAN)
        ...
        self.CheckButton_Sampler.configure(variable=Kegerator_V2_support.CheckSampler)
        ...
        self.CheckButton_Small.configure(variable=Kegerator_V2_support.CheckSmall)
        ...
        self.CheckButton_Large.configure(text='''Large (16 oz)''')
        self.CheckButton_Large.configure(variable=Kegerator_V2_support.CheckLarge)
...
############## Custom Fuctions ###################################
    ...
    def COMMAND_START_POUR(self):
        if any(self.Beer_Selected_State):
            Kegerator_V2_support.LED_ON()
            #Kegerator_V2_support.RELAY_ON()
